<?php
  ...
  *
  * @param Angie_DateTime $value If value is not instance of DateTime object new DateTime
  ...
  */
  function format_datetime($value = null, $format = null, $timezone = null) {
    ...
    $datetime = $value instanceof Angie_DateTime ? $value : new Angie_DateTime($value);
