<?php
  ...
  /**
  * Inflector is used to pluralize and singularize English words, transform table names to
  * class names, underscored strings to camel case etc
  *
  * Inflector is taken from CakePHP project. Original can be found in Rails framework
  * 
  * @package Angie.toys
  */
  final class Angie_Inflector {
