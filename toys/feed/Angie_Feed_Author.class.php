<?php
  ...
  */
  class Angie_Feed_Author {
    ...
    * @throws Angie_Core_Error_InvalidParamValue if $email or $link values are present but they are not valid
    */
    ...
    */
    function setEmail($value) {
      if(!is_null($value) && !is_valid_email($value)) {
        throw new Angie_Core_Error_InvalidParamValue('value', $value, "$value is not a valid email address");
      } // if
      $this->email = $value;
    } // setEmail
    ...
    */
    function setLink($value) {
      if(!is_null($value) && !is_valid_url($value)) {
        throw new Angie_Core_Error_InvalidParamValue('value', $value, "$value is not a valid URL");
      } // if
      $this->link = $value;
    } // setLink
